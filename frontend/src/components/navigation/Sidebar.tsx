...
import { LayoutDashboard, Server, UserPlus, FileText, BarChart3, Shield, X } from "lucide-react";
...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-40 flex w-64 flex-col border-r bg-card/95 backdrop-blur-sm",
          "transition-transform duration-300 ease-premium",
          "lg:static lg:z-20 lg:translate-x-0 lg:bg-card/80",
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 pt-7 pb-6">
          ...
          <button
            type="button"
            onClick={onClose}
            className="lg:hidden flex h-8 w-8 items-center justify-center rounded-lg text-muted-foreground hover:bg-accent/60 hover:text-foreground transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
        ...
        {/* Navigation */}
        <nav className="flex flex-1 flex-col gap-0.5 px-3 overflow-y-auto" aria-label="Main navigation">
